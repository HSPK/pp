...
Pi uses the [Kitty keyboard protocol](https://sw.kovidgoyal.net/kitty/keyboard-protocol/) and xterm modified-key sequences for reliable modifier key detection. Most modern terminals support these protocols, but some require configuration.
